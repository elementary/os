...
wget -O arm-trusted-firmware-${tfaver}.tar.gz https://github.com/ARM-software/arm-trusted-firmware/archive/refs/tags/v$tfaver.tar.gz
wget "ftp://ftp.denx.de/pub/u-boot/u-boot-${ubootver}.tar.bz2"

echo "304d372327d6ecabf89da67e2e1a7b2660f13b5851886fef1b58ae5a6d74e606 arm-trusted-firmware-${tfaver}.tar.gz" | sha256sum --check
echo "c1f5bf9ee6bb6e648edbf19ce2ca9452f614b08a9f886f1a566aa42e8cf05f6a u-boot-${ubootver}.tar.bz2" | sha256sum --check

tar xf "arm-trusted-firmware-${tfaver}.tar.gz"
tar xf "u-boot-${ubootver}.tar.bz2"

# These tarballs are extracted now, delete them
rm "arm-trusted-firmware-${tfaver}.tar.gz"
rm "u-boot-${ubootver}.tar.bz2"

cd "arm-trusted-firmware-${tfaver}"
...
rm -rf "${basedir}/arm-trusted-firmware-${tfaver}"
