...
apt-get -q -y install --no-install-recommends elementary-sdk
apt-get -q -y install sudo git devscripts debhelper dctrl-tools dpkg-dev genisoimage gfxboot-theme-ubuntu isolinux live-build squashfs-tools syslinux syslinux-utils
